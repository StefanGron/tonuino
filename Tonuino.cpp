...
void resetSettings() {
  ...
  mySettings.maxVolume = 14;
  mySettings.minVolume = 4;
  mySettings.initVolume = 10;
  mySettings.eq = 1;
  mySettings.locked = false;
  mySettings.standbyTimer = 0;
  mySettings.invertVolumeButtons = false;
  mySettings.shortCuts[0].folder = 6;
  mySettings.shortCuts[1].folder = 7;
  mySettings.shortCuts[2].folder = 8;
...
void setup() {
  ...
  Serial.println(F("created by Thorsten Voß mod SGr and licensed under GNU/GPL."));
